...
const REPULSIVE_CONSTANT = 0.4;
const REPULSIVE_RADIUS = 0.8;
function InteractionForce(a, b, gravity, electric, repulsive) {
...
class Universe {
    constructor(framerate, gravity, electric, repulsive) {
        this.matter_list = [];
        this.graphics = [];
